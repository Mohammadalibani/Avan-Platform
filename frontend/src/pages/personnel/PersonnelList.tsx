...
const PersonnelList: React.FC = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      console.log('✅ Personnel:', personnelRes.data);
      console.log('✅ Fields:', fieldsRes.data);
      console.log('✅ Departments:', deptsRes.data);
      console.log('✅ Units:', unitsRes.data);
      console.log('✅ Periods:', periodsRes.data);
      
      // 🔍 نمایش ساختار اولین پرسنل برای دیباگ
      if (personnelRes.data.personnel && personnelRes.data.personnel.length > 0) {
        const first = personnelRes.data.personnel[0];
        console.log('🔍 ساختار اولین پرسنل:', first);
        console.log('🔍 کلیدهای موجود:', Object.keys(first));
        console.log('🔍 values:', first.values);
        console.log('🔍 کلیدهای values:', Object.keys(first.values || {}));
      }
